# Spec: xml-section-style

## Purpose

Defines the `SectionStyle` option on `AgentWriter.Options` that controls whether Section nodes are rendered as Markdown headings or XML tags.
