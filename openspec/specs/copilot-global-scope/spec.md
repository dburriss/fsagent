# Spec: Copilot Global Scope

## Purpose

Defines how Copilot global scope is resolved when no explicit root is provided, supporting an environment variable fallback (`COPILOT_GLOBAL_ROOT`) before raising `NotSupportedException`.
