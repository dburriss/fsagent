...
This capability provides harness-aware template rendering, allowing `{{{tool <Name>}}}` syntax in templates to resolve to the correct tool name for the active agent harness (e.g., Opencode, Copilot, ClaudeCode).
